document.addEventListener('DOMContentLoaded', () => {
  ...
  let callBackButton = document.getElementById('callback-button-entry');

  // Модальное окно, которое необходимо открыть
  let modal1 = document.getElementById('modal-entry');
  ...
  let buttonOpenModal1 = document.getElementsByClassName('get-modal_entry');
