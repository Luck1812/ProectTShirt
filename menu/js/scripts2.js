document.addEventListener('DOMContentLoaded', () => {
  ...
  let callBackButton = document.getElementById('callback-button-registry');

  // Модальное окно, которое необходимо открыть
  let modal1 = document.getElementById('modal-registry');
  ...
  let buttonOpenModal1 = document.getElementsByClassName('get-modal_registry');
